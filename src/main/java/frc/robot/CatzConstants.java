...
public final class CatzConstants {
 ...
 public static final class OIConstants {
  ...
  public static final class DriveConstants {
    ...
    //Requirements: each set is (4); 1 set of offsets, 1 set of Drive IDs, 1 set of Steer IDs, 1 set of Enc_Ports
    ...
    //Unknown:                                                            //Atlas
    // public static final double LT_FRNT_OFFSET = 0.510253350256333775;  //0.5112305378; 
    ...
    public static final int LT_FRNT_DRIVE_ID = 1; 
    public static final int LT_BACK_DRIVE_ID = 3;
    public static final int RT_BACK_DRIVE_ID = 5; //SN1 22 //SN2 5
    public static final int RT_FRNT_DRIVE_ID = 7; 
